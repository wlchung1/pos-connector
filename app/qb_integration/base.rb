module POSConnector
  module QBIntegration
    ...
    class QBIntegrationException < StandardError; end

    class RecordNotFound < QBIntegrationException; end
    class InvalidPlatformException < QBIntegrationException; end
    class LookupValueNotFoundException < QBIntegrationException; end
    class UnsupportedException < QBIntegrationException; end
    class AlreadyPersistedOrderException < QBIntegrationException; end
    class NoReceiptForOrderException < QBIntegrationException; end

    class MissingTimestampParam < QBIntegrationException
      def message
